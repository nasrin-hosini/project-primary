...
def get_weather():
    try:
        ...
        # Weather:
        api_key = "8dfca592aac33646c0074863e7212ebf"
        ...
        desccription_label.config(text=description)
...
desccription_label = tk.Label(root, text="...", font=("arial", 20, "bold"),
                      bg="#1ab5ef", fg="#404040")
desccription_label.place(x=450, y=430)
